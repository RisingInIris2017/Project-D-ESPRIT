...
datatip(dpm_10_2,-15,RMSE_10(1,2),'SnapToDataVertex','off');
datatip(dpm_20_1,-15,RMSE_20(1,1),'SnapToDataVertex','off');
datatip(dpm_20_2,-15,RMSE_20(1,2),'SnapToDataVertex','off');
datatip(dpm_30_1,-15,RMSE_30(1,1),'SnapToDataVertex','off');
datatip(dpm_30_2,-15,RMSE_30(1,2),'SnapToDataVertex','off');

datatip(dpm_2_1,-10,RMSE_2(2,1),'SnapToDataVertex','off');
datatip(dpm_2_2,-10,RMSE_2(2,2),'SnapToDataVertex','off');
datatip(dpm_10_1,-10,RMSE_10(2,1),'SnapToDataVertex','off');
datatip(dpm_10_2,-10,RMSE_10(2,2),'SnapToDataVertex','off');
datatip(dpm_20_1,-10,RMSE_20(2,1),'SnapToDataVertex','off');
datatip(dpm_20_2,-10,RMSE_20(2,2),'SnapToDataVertex','off');
datatip(dpm_30_1,-10,RMSE_30(2,1),'SnapToDataVertex','off');
datatip(dpm_30_2,-10,RMSE_30(2,2),'SnapToDataVertex','off');
